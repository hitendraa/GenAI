...
@InputType()
class InventoryCreateNestedManyWithoutProductsInput {
...
export { InventoryCreateNestedManyWithoutProductsInput as InventoryCreateNestedManyWithoutProductsInput };
